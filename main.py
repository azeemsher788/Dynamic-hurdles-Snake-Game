...
screen.onkey(lambda: snake.add_to_sequence("D"), "Down")
screen.onkey(lambda: snake.add_to_sequence("@"), "@")
screen.onkey(lambda: snake.add_to_sequence("G"), "g")
screen.onkey(lambda: snake.add_to_sequence("$"), "$")
screen.onkey(lambda: snake.add_to_sequence("J"), "j")
screen.onkey(lambda: snake.add_to_sequence("^"), "^")
